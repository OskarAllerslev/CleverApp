...
overview: "Regression er metoden til at fitte en matematisk model til rå data. Du bruger det til at forudsige fremtidige værdier og forstå sammenhænge i datasæt fra virkeligheden."
goals:
...
intuition: "Regression finder den linje (eller kurve), der minimerer den samlede fejl til alle datapunkter. Det er som at finde den 'gennemsnitlige tendens' i et rodet datasæt."
---
...
<ExerciseHub
  ...
  questions={[
    ...
    "Ingen af delene"
      ...
      {
        quizId: "funktioner-regression-quiz-premium",
      ...
      },
      {
        ...
        options: [
          "$98\%$ af variationen i y-værdierne forklares af den lineære model",
          "Modellen har en fejl på $2\%$ i alle forudsigelser",
          "Hældningen på linjen er positiv",
          "Modellen er $100\%$ sand for alle data"
        ],
        correctIndex: 0,
