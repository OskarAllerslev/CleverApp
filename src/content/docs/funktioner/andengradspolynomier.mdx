...
overview: "Andengradsfunktioner giver parablen – en kurve der optræder i kastet bold, lyspærer og optimeringsopgaver. Her lærer du at finde toppunktet, nulpunkter og skæringer."
goals:
...
intuition: "Fortegnet på a afgør alt: hvis a > 0 vender parablens arme op (smiley), og toppunktet er et minimum. Hvis a < 0 vender armene ned (trist ansigt), og toppunktet er et maksimum."
---
...
<ExerciseHub
  ...
  questions={[
    ...
    "x = 12"
      ...
      {
        quizId: "funktioner-andengradspolynomier-quiz-premium",
