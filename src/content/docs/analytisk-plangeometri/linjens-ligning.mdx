...
overview: "Analytisk plangeometri binder algebra og geometri sammen. Linjens ligning giver dig et præcist algebraisk udtryk for enhver ret linje i koordinatsystemet – med normalvektor og retningsvektor som centrale begreber."
goals:
...
intuition: "En linjes ligning er en betingelse: den beskriver alle de punkter (x, y) der opfylder en bestemt lineær relation. Normalvektoren peger vinkelret på linjen og er nøglen til linjens orientering."
---
...
<LineEquationVisualizer client:load />
...
<ExerciseHub
  ...
  questions={[
    ...
    "$(7, 11)$"
      ...
      {
        quizId: "analytisk-plangeometri-linjens-ligning-quiz-premium",
