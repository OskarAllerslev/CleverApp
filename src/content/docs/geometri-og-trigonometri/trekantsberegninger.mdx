...
overview: "Vilkårlige trekanter (ikke-retvinklede) kræver sinus- og cosinusrelationerne. Disse kraftfulde formler løser alle typer trekantberegninger – uanset om du kender sider, vinkler eller begge."
goals:
...
intuition: "Sinusrelationen er din ven, når du har et sæt af (vinkel, modstående side). Cosinusrelationen tager over, når du mangler en vinkel eller har alle tre sider."
---
...
<TriangleDraggerVisualizer client:load />
...
<ExerciseHub
  ...
  questions={[
    ...
    "45"
      ...
      {
        quizId: "geometri-og-trigonometri-trekantsberegninger-quiz-premium",
