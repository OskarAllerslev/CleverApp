...
overview: "Binomialfordelingen modellerer eksperimenter med to mulige udfald (succes/fiasko), der gentages n gange. Det er den vigtigste diskrete sandsynlighedsfordeling i gymnasiematematik."
goals:
...
intuition: "Forestil dig n møntkast, og du vil vide sandsynligheden for præcis k plat. Binomialformlen beregner det eksakt – ved at tælle alle de mulige måder k succeser kan forekomme."
---
...
<ExerciseHub
  ...
  questions={[
    ...
    "Testen er ugyldig"
      ...
      {
        quizId: "avanceret-statistik-binomialfordeling-quiz-premium",
