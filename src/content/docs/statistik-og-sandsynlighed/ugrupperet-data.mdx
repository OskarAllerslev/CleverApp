...
overview: "Beskrivende statistik for ugrupperet data giver dig værktøjerne til at opsummere et datasæt med tal. Middelværdi, median, typetal og spredning er de vigtigste deskriptorer."
goals:
...
intuition: "Middelværdien fortæller dig tyngdepunktet i data. Medianen fortæller dig midtpunktet. Og standardafvigelsen fortæller dig, hvor spredt data er om middelværdien."
---
...
<ExerciseHub
  ...
  questions={[
    ...
    "Der er ingen outliers"
      ...
      {
        quizId: "statistik-og-sandsynlighed-ugrupperet-data-quiz-premium",
