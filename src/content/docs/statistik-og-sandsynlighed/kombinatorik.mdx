...
overview: "Kombinatorik handler om at tælle på en smart måde. Du lærer at beregne antallet af måder at vælge og arrangere elementer – essentielt for avanceret sandsynlighedsregning."
goals:
...
intuition: "Kombinatorik er svaret på spørgsmålet: 'Hvor mange måder kan det ske på?' Rækkefølge betyder alt for permutationer, men intet for kombinationer."
---
...
<ExerciseHub
  ...
  questions={[
    ...
    "Begge dele"
      ...
      {
        quizId: "statistik-og-sandsynlighed-kombinatorik-quiz-premium",
