...
overview: "Skalarproduktet og krydsproduktet er to måder at 'gange' vektorer på med helt forskelligt resultat. Skalarproduktet giver et tal og fortæller om vinklen, mens krydsproduktet giver en ny vektor vinkelret på begge."
goals:
...
intuition: "Skalarproduktet måler 'hvor meget' to vektorer peger i samme retning. Krydsproduktet finder den vektor der er vinkelret på begge – og arealet af det parallelogram de danner."
---
...
<ExerciseHub
  ...
  questions={[
    ...
    "100"
      ...
      {
        quizId: "matematik-a-vektorer-og-analytisk-geometri-skalar-og-krydsprodukt-quiz-premium",
