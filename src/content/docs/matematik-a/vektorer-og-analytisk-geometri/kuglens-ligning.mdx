...
overview: "Kuglens ligning er Pythagoras' sætning i tre dimensioner. Ligesom cirklens ligning beskriver alle punkter med en given afstand til centrum i planen, beskriver kuglens ligning det tilsvarende i rummet."
goals:
...
intuition: "Kuglens ligning er egentlig bare definitionen på afstand i 3D: alle punkter med afstand r til centrum. Det er Pythagoras tre gange i stedet for to!"
---
...
<ExerciseHub
  ...
  questions={[
    ...
    "Når normalvektoren til planet peger mod centrum"
      ...
      {
        quizId: "matematik-a-vektorer-og-analytisk-geometri-kuglens-ligning-quiz-premium",
