...
overview: "Intervalsandsynligheder for kontinuerte fordelinger beregnes ved integration af tæthedsfunktionen. Det er overgangen fra diskrete sandsynligheder til kontinuerte – et fundamentalt skifte i perspektiv."
goals:
  - "Forstå og beregne sandsynligheder som arealer under tæthedsfunktionen"
  - "Anvende integraler til at beregne P(a ≤ X ≤ b)"
  - "Bestemme middelværdi og varians for kontinuerte fordelinger"
  - "Anvende disse teknikker på normalfordelingen specifikt"
intuition: "For en kontinuert variabel er sandsynligheden for præcis ét bestemt tal altid nul. Kun intervaller har sandsynligheder – og de beregnes som arealet under kurven over intervallet."
---
...
<ExerciseHub
  ...
  questions={[
    ...
    "n ≥ 100"
      ...
      {
        quizId: "matematik-a-avanceret-statistik-og-sandsynlighed-intervalsandsynlighed-quiz-premium",
        ...
        options: [
          "$\hat{p} = 0.45$, fejlmargen $= 0.03$",
          "$\hat{p} = 0.45$, fejlmargen $= 0.06$",
          "$\hat{p} = 0.46$, fejlmargen $= 0.02$",
          "$\hat{p} = 0.44$, fejlmargen $= 0.04$"
        ],
        correctIndex: 0,
