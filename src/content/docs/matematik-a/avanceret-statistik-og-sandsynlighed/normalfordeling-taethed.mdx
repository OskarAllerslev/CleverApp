...
overview: "Normalfordelingen er den vigtigste sandsynlighedsfordeling i statistikken. Den symmetriske klokkeformel opstår naturligt i utallige situationer og er grundlaget for næsten al statistisk inferens."
goals:
...
intuition: "Normalfordelingen opstår, når mange uafhængige tilfældige faktorer adderes (Centralgrænsesætningen). Derfor ser vi den overalt: højder, testresultater, målefejl – alt følger denne klokkeform."
---
...
<ExerciseHub
  ...
  questions={[
    ...
    "Ca. 10 %"
      ...
      {
        quizId: "matematik-a-avanceret-statistik-og-sandsynlighed-normalfordeling-taethed-quiz-premium",
