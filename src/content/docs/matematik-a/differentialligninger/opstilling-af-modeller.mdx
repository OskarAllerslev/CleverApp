...
overview: "Differentialligninger beskriver systemer der ændrer sig over tid. Her lærer du at oversætte fysiske og biologiske sammenhænge til matematiske ligninger som kan løses analytisk eller numerisk."
goals:
  - "Identificere og opstille differentialligninger fra verbale beskrivelser"
  - "Kende til lineære og separable differentialligninger"
  - "Verificere løsninger til differentialligninger"
  - "Tolke begyndelsesværdier og steady-state løsninger"
intuition: "En differentialligning fortæller dig noget om HASTIGHEDEN af en ændring, ikke om størrelsen selv. Du skal 'integrere' informationen for at finde selve funktionen."
---
...
<ExerciseHub
  ...
  questions={[
    ...
    "k = -0,693"
      ...
      {
        quizId: "matematik-a-differentialligninger-opstilling-af-modeller-quiz-premium",
        ...
        options: [
          "$\frac{dT}{dt} = -0.05(T - 20)$",
          "$\frac{dT}{dt} = 0.05T$",
          "$\frac{dT}{dt} = -0.05T(T - 20)$",
          "$\frac{dT}{dt} = -0.05(20 - T)$"
        ],
        correctIndex: 0,
      ...
      },
      {
        ...
        options: [
          "$\frac{dy}{dt} = k \cdot \sqrt{y}$",
          "$\frac{dy}{dt} = k \cdot y^2$",
          "$\frac{dy}{dt} = \frac{k}{\sqrt{y}}$",
          "$y(t) = k \cdot \sqrt{t}$"
        ],
        correctIndex: 0,
